...
class ListenerController extends Controller
{
    ...
    function orderNotification(Request $request)
    {
        ...
        Storage::disk('local')->put('order-notification-header.txt', $request->header("Authorization-Hmac"));
    }
    ...
    function orderStatus(Request $request)
    {
        ...
        Storage::disk('local')->put('order-status-header.txt', $request->header("Authorization-Hmac"));
    }

    function orderCancellation(Request $request)
    {
        Storage::disk('local')->put('order-cancellation-content.txt', $request->getContent());
        Storage::disk('local')->put('order-cancellation-header.txt', $request->header("Authorization-Hmac"));
    }
    ...
    function orderConfirmDeliveryNotification(Request $request)
    {
        ...
        Storage::disk('local')->put('order-confirmDelivery-header.txt', $request->header("Authorization-Hmac"));
    }
